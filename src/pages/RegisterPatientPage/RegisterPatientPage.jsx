    ...
    <>
      ...
      >
        <div className={S.containerForm}>
          ...
          <label className={S.labelForm} for="namePatient">
            Nome Completo:
          </label>
          <input
          ...
          <div className={S.divForms}>
            <div>
              <label className={S.labelForm} for="date_birth">
                Data de nascimento:
              </label>
              <input
                className={S.inputForm}
            ...
            <div>
              <label className={S.labelForm} for="cpf_patient">
                CPF:
              </label>
              <input
                className={S.inputForm}
          ...
          >
            <label className={S.labelForm} for="sex">
              Sexo:
            </label>
            <div>
              <label for="feminine" style={{ marginRight: '7px' }}>
                Feminino
              </label>
              <input
                type="radio"
            ...
            <div>
              <label for="masculine" style={{ marginRight: '7px' }}>
                Masculino
              </label>
              <input
                type="radio"
          ...
          <label className={S.labelForm} for="phone">
            Telefone:
          </label>
          <input
            className={S.inputForm}
