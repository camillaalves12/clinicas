    ...
    try {
      ...
      if (schedulings.length === 0) {
        return res
          .status(400)
          .json({
            error: "Não foram encontrados agendamentos com esse paciente.",
          });
      }
    ...
    try {
      ...
      if (schedulings.length === 0) {
        return res
          .status(400)
          .json({
            error: "Não foram encontrados agendamentos com esse profissional.",
          });
      }
    ...
    try {
      ...
      if (schedulings.length === 0) {
        return res
          .status(400)
          .json({
            error: "Não foram encontrados agendamentos com esse procedimento.",
          });
      }
    ...
    try {
      ...
      if (!scheduling) {
        return res
          ...
          .json({
            message:
              "Não foram encontrados registros de agendamentos com esse ID!",
          });
      }
