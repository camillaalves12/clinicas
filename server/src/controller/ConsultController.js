  ...
  async createConsult(req, res) {
    ...
    try {
      ...
      if (!clinic) {
        return res
          .status(400)
          .json({ message: "Não foram encontrados clínicas com esse ID!" });
      } else if (!patient) {
        return res
          .status(400)
          .json({ message: "Não foram encontrados pacientes com esse ID!" });
      } else if (!professional) {
        return res
          .status(400)
          .json({
            message: "Não foram encontrados profissionais com esse ID!",
          });
      } else if (!procedimento) {
        return res
          .status(400)
          .json({
            message: "Não foram encontrados procedimentos com esse ID!",
          });
      }
    ...
    try {
      ...
      if (consults.length === 0) {
        return res
          .status(400)
          .json({
            error: "Não foram encontrados consultas com esse paciente.",
          });
      }
    ...
    try {
      ...
      if (consults.length === 0) {
        return res
          .status(400)
          .json({
            error: "Não foram encontrados consultas com esse profissional.",
          });
      }
    ...
    try {
      ...
      if (consults.length === 0) {
        return res
          .status(400)
          .json({
            error: "Não foram encontrados consultas com esse procedimento.",
          });
      }
    ...
    try {
      ...
      if (!consult)
        return res
          .status(400)
          .json({
            error: "Não foram encontrados registros de consultas com esse ID!",
          });
    ...
    try {
      ...
      if (!consult) {
        return res
          ...
          .json({
            message:
              "Não foram encontrados registros de consultas com esse ID!",
          });
      }
